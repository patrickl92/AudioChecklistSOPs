...
landingChecklist:addItem(automaticChecklistItem:new("SPEEDBRAKE", "ARMED", "Landing_SpeedBrake", function() return utils.readDataRefFloat("laminar/B738/annunciator/speedbrake_armed") == 1 end))
